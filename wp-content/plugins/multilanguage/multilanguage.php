			...
			case 'flags-icons':
				$switcher .= '<form name="mltlngg_change_language" method="post" action="">';
					foreach ( $mltlngg_enabled_languages as $mltlngg_one_lang ) {
						...
						$flagClass = ( $mltlngg_one_lang['locale'] == $mltlngg_current_language ) ? 'mltlngg-current-lang' : 'mltlngg-lang';
						$switcher .= '<button class="btn mltlngg-lang-button-icons '.$flagClass.'" name="mltlngg_change_display_lang" value="' . $mltlngg_one_lang['locale'] . '" title="' . $mltlngg_one_lang['name'] . '">';
							$switcher .= $mltlngg_one_lang['locale'];
							$switcher .= '</button>';
							$switcher .= '<span class="flag_separator"></span>';
					}
				$switcher .= '</form>';
				break;
		}
